...
const DB = { // Keep DB object globally accessible
    ...
    insertRows: async function (tableName, result) {
        ...
        // console.log(schema);
        generateAndDisplaySuggestedPromptsDataChat("Suggest diverse and useful questions that a user can answer from this dataset using SQLite. Note: Do not assume any kind of filtering on column data with a specific value just write questions based on retreival of top results which should not be based on specific name.",schema);
    },
};
